...
public class ConfigurableComponentWithVersionNoName {

	private static final Logger logger = Logger.getLogger(ConfigurableComponentWithVersionNoName.class.getName());
	...
	public void postConstruct() {
		logger.log(Level.INFO, "[POST-CONSTRUCT] @Configurable test object with name={0} and version={1}", new Object[]{"<default>", "1.0.0"});
		logger.log(Level.INFO, "[PROPERTY] component.test.property = {0}", new Object[]{componentTestProperty});
	}

	@PreDestroy
	public void preDestroy() {
		logger.log(Level.INFO, "[PRE-DESTROY] @Configurable test object with name={0} and version={1}", new Object[]{"<default>", "1.0.0"});
	}
